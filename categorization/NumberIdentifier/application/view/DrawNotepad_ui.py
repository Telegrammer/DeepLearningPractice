...
from categorization.NumberIdentifier.application.model_view.CanvasHeart import CanvasHeart
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 10, 120, 150))
        ...
        self.backColorSelect.setGeometry(QtCore.QRect(10, 100, 93, 28))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.backColorSelect.setStyleSheet("background-color: rgb(255, 255, 255);")
